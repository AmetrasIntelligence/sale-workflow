    ...
    def _check_package(self):
        if self.product_packaging:
            rounded_up_qty = float_round(
                ...
                precision_rounding=self.product_packaging.sale_rounding,
                rounding_method="UP",
            )
            if self.product_packaging_qty != rounded_up_qty:
                ...
                q = self.product_id.uom_id._compute_quantity(
                    self.product_packaging.actual_sale_qty, self.product_uom
                )
                    ...
                    return {
                        "warning": {
                            ...
                            % (
                                ...
                                self.product_id.uom_id.name,
                                round(1 / self.product_packaging.sale_rounding, 0),
                            ),
                        },
                    }
            return {}
